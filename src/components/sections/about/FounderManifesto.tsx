...
export function FounderManifesto() {
    return (
        <>
            ...
            {/* The Kinetic Culture: BUILD with FIRE - Full Width Blueprint Section */}
            <section className="py-24 bg-blueprint-gray bg-blueprint-grid relative overflow-hidden">
                {/* Opacity 10 Grid Overlay handled by parent bg class, or explicit here if needed. 
                    Adding explicit overlay for clarity if bg-blueprint-grid isn't sufficient.
                     Actually user asked for "opacity-10 grid". 'bg-blueprint-grid' usually puts a pattern. 
                     Let's ensure it looks subtle.
                */}
                <div className="absolute inset-0 bg-blueprint-grid opacity-[0.10] pointer-events-none mix-blend-multiply" />
